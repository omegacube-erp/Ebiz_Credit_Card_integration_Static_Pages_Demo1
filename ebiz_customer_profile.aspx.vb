...
Imports System.Net
Imports System.Xml
Partial Class ebiz_customer_profile
...
'added Code for getting URL and Action Id from TOOL Settings on 27 AUGUST 2020 by deepu
				...
				dsactionurl=Return_record_set("select VALUE from SYS_TOOL_SETTINGS where KEY ='EBIZ_ACTION_URL_CUST_PROFILE'")
				dsactionurl.Clear()
				...
				End If
				Catch ex As Exception
                                                                        TLactionURL = "http://eBizCharge.ServiceModel.SOAP/IeBizService/GetCustomer"
                                                                    End Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    If (str1 <> "") Then
                        ...
                        ds3.Clear()
                        ds3.ReadXml(reader)
                        If (ds3.Tables("PaymentMethodProfile").Rows.Count > 0) Then
                            Label1.Text = ds3.Tables(0).TableName
                            dbg.DataSource = ds3.Tables("PaymentMethodProfile")
                            dbg.DataBind()
                    ...
                    Else
                        ...
                        strCmd1 = String.Format("alert('There is No profiles exist for this customer.');window.opener.document.getElementById('" & Request.QueryString.Get("Retrive_id") & "').click();window.close();", strFile1)
    ...
    Public Function SOAPManual(ByVal ds1 As Data.datatable, ByVal USER_ID As String,ByVal url As String,ByVal action As String,ByVal TLSecurityID As String) As String
        ...
        'Const action As String = "http://eBizCharge.ServiceModel.SOAP/IeBizService/GetCustomer"
        ...
        ebiz_customer_profile.InsertSoapEnvelopeIntoWebRequest(soapEnvelopeXml, webRequest)
